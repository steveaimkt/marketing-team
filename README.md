...
| **②** | **`1-시작하기`** 로 우리 회사 정보 | 100개가 **우리 값으로** 돕니다. 3분 |
...
| 스킬 | 언제 |
|---|---|
| `1-시작하기` | 설치 직후 점검 · 작업 폴더 생성 · 브랜드 정보 등록 |
...
저장소를 클론해 폴더를 열어도 된다. 열고 나서 **`1-시작하기`**. `.claude/agents` · `.claude/skills` 가
...
plugins/marketing-team/           ← 플러그인 본체 (설치되는 것은 이 폴더다)
  ...
  skills/       1-시작하기 · 스킬-100-보기 · 마케팅-CMO
